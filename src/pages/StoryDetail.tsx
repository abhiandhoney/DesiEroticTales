    ...
    <article className="page story-detail-page">
      ...
      <header className="story-header">
        ...
        <div className="story-detail-meta">
          ...
          <span>·</span>
          <span>{new Date(story.created_at).toLocaleDateString('en-IN', {
      ...
      {/* ADSTERRA: Above-content ad */}
      <div className="ad-slot ad-slot-story-top" data-adsterra="story-top">
      ...
      {/* ADSTERRA: Below-content ad */}
      <div className="ad-slot ad-slot-story-bottom" data-adsterra="story-bottom">
        {/* Insert Adsterra ad unit here */}
      </div>
